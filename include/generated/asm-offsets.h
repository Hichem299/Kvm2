...
#define THREAD_CPU_CONTEXT 3520 /* offsetof(struct task_struct, thread.cpu_context) */
#define THREAD_SCTLR_USER 4600 /* offsetof(struct task_struct, thread.sctlr_user) */
#define THREAD_KEYS_USER 4496 /* offsetof(struct task_struct, thread.keys_user) */
#define THREAD_KEYS_KERNEL 4576 /* offsetof(struct task_struct, thread.keys_kernel) */
#define THREAD_MTE_CTRL 4592 /* offsetof(struct task_struct, thread.mte_ctrl) */
...
#define VCPU_CONTEXT 272 /* offsetof(struct kvm_vcpu, arch.ctxt) */
#define VCPU_FAULT_DISR 2176 /* offsetof(struct kvm_vcpu, arch.fault.disr_el1) */
#define VCPU_HCR_EL2 2120 /* offsetof(struct kvm_vcpu, arch.hcr_el2) */
