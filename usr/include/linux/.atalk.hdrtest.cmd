cmd_usr/include/linux/atalk.hdrtest := gcc -std=c90 -Wall -Werror=implicit-function-declaration -Wp,-MMD,usr/include/linux/.atalk.hdrtest.d -I./usr/include -S -o /dev/null -x c /dev/null  -include usr/include/linux/atalk.h -include usr/include/linux/atalk.h; perl ./scripts/headers_check.pl usr/include arm64 usr/include/linux/atalk.h; touch usr/include/linux/atalk.hdrtest
