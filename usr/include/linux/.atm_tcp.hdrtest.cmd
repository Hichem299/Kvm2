cmd_usr/include/linux/atm_tcp.hdrtest := gcc -std=c90 -Wall -Werror=implicit-function-declaration -Wp,-MMD,usr/include/linux/.atm_tcp.hdrtest.d -I./usr/include -S -o /dev/null -x c /dev/null  -include usr/include/linux/atm_tcp.h -include usr/include/linux/atm_tcp.h; perl ./scripts/headers_check.pl usr/include arm64 usr/include/linux/atm_tcp.h; touch usr/include/linux/atm_tcp.hdrtest
