cmd_usr/include/linux/fiemap.hdrtest := gcc -std=c90 -Wall -Werror=implicit-function-declaration -Wp,-MMD,usr/include/linux/.fiemap.hdrtest.d -I./usr/include -S -o /dev/null -x c /dev/null  -include usr/include/linux/fiemap.h -include usr/include/linux/fiemap.h; perl ./scripts/headers_check.pl usr/include arm64 usr/include/linux/fiemap.h; touch usr/include/linux/fiemap.hdrtest
