cmd_usr/include/linux/mroute.hdrtest := gcc -std=c90 -Wall -Werror=implicit-function-declaration -Wp,-MMD,usr/include/linux/.mroute.hdrtest.d -I./usr/include -S -o /dev/null -x c /dev/null  -include usr/include/linux/mroute.h -include usr/include/linux/mroute.h; perl ./scripts/headers_check.pl usr/include arm64 usr/include/linux/mroute.h; touch usr/include/linux/mroute.hdrtest
