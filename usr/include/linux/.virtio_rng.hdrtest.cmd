cmd_usr/include/linux/virtio_rng.hdrtest := gcc -std=c90 -Wall -Werror=implicit-function-declaration -Wp,-MMD,usr/include/linux/.virtio_rng.hdrtest.d -I./usr/include -S -o /dev/null -x c /dev/null  -include usr/include/linux/virtio_rng.h -include usr/include/linux/virtio_rng.h; perl ./scripts/headers_check.pl usr/include arm64 usr/include/linux/virtio_rng.h; touch usr/include/linux/virtio_rng.hdrtest
